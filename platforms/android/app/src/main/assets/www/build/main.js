...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ingpassword_ingpassword__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__politicas_politicas__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__msjsopporte_msjsopporte__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recuperacontra_recuperacontra__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__quees_quees__ = __webpack_require__(179);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__micuenta_micuenta__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ayuda_ayuda__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__acercade_acercade__ = __webpack_require__(174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menuconfig_menuconfig__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_ingpassword_ingpassword__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_politicas_politicas__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_recuperacontra_recuperacontra__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_principal_principal__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_quees_quees__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_menuconfig_menuconfig__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_micuenta_micuenta__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_ayuda_ayuda__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_acercade_acercade__ = __webpack_require__(174);
        ...
        if (numero === "" || numero === null || numero === undefined || numero.length < 10) {
            ...
            this.http.update_clave_cleinte(datos)
                ...
                _this.sms.send('+52' + numero, 'La contraseña para qvaluation es: ' + resp["clave"])
                    .then(function (data) {
                    _this.loandings.dismiss();
                    _this.alertpassword("Contraseña", 'Verifica los SMS en tu teléfono, ingresa la contraseña que se te ha enviado y presiona ACEPTAR', empresa, tipo);
                }, function (error) {
                    _this.loandings.dismiss();
        ...
        if (numero === "" || numero === null || numero === undefined || numero.length < 10) {
            ...
            this.http.update_clave_cleinte(datos)
                ...
                _this.sms.send('+52' + numero, 'La contraseña para qvaluation es: ' + resp["clave"])
                    .then(function (data) {
                    _this.loandings.dismiss();
                    _this.alertpassword("Login", 'Verifica los SMS en tu teléfono, ingresa la contraseña que se te ha enviado y presiona ACEPTAR', empresa, tipo);
                }, function (error) {
                    _this.loandings.dismiss();
                    _this.alertinfo("Alerta", "Error: " + JSON.stringify(error));
                });
