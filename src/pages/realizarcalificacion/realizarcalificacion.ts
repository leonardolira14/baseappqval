...
@IonicPage()
@Component({
  selector: 'page-realizarcalificacion',
  templateUrl: 'realizarcalificacion.html',
})
export class RealizarcalificacionPage {
 ...
 public datosusuario:any=[];
  ...
  constructor(public http: HttpProvider,public toastCtrl: ToastController,private barcodeScanner: BarcodeScanner,public alertCtrl: AlertController,private formBuilder: FormBuilder,public navCtrl: NavController, public navParams: NavParams) {
